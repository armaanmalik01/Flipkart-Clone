...
export default function Product(props) {
    ...
    const {info, allproducts} = useLoaderData();



    if (info.error) {
        return <p style={{ textAlign: "center", fontWeight: "500", margin: "20px 0xp", marginTop: "100px", fontSize: "1rem" }}>{info.error}</p>
    }
    ...
    return <div aria-label="product page" style={
        ...
        <div aria-label="sale countdown" style={{ padding: "2px 0px", margin: "5px 0px", background: "#fff" }}>
            <Timer label={"FLIPKART THE HOLI BIG SALE"} />
        </div>
